...
print(arr)     # [1, 99, 2, 10, 4, 5]`
    },
    {
      ...
      description: "JavaScript의 Array 역시 동적 배열이며, 다양한 내장 메서드를 제공합니다.",
      code: `// 1. 배열 선언 및 초기화
const arr = [1, 2, 3, 4, 5];
...
// 6. 요소 삭제 (Pop) - O(1) (끝 삭제)
arr.pop();
console.log(arr);     // [1, 99, 2, 10, 4, 5]`
    },
    {
      language: 'cpp' as const,
      description: "C++에서는 STL의 <code>std::vector</code>를 사용하여 동적 배열을 구현합니다.",
      code: `// 1. Vector 선언 (동적 배열)
#include <vector>
#include <iostream>
using namespace std;
...
int main() {
    ...
    },
    {
      ...
      description: "Java에서는 <code>ArrayList</code> 클래스를 사용하여 크기가 조정되는 배열을 구현합니다.",
...
# 마지막 요소 제거 (Pop)
arr.pop()`,
    javascript: `// JavaScript 배열 기본 연산
const arr = [10, 25, 30];

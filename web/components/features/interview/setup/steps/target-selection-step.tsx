...
export function TargetSelectionStep() {
  ...
  const handleNext = async () => {
    ...
    // Save to store
    setTarget(urlInput, "Custom");
    // In a real app, we would fetch JD here. For now, use Mock.
    setJobData({
       role: MOCK_JD_RESULT.role,
       company: MOCK_JD_RESULT.company || "Unknown",

       // New Fields with Default Fallbacks
       companyDescription: MOCK_JD_RESULT.companyDescription || "",
       teamCulture: MOCK_JD_RESULT.teamCulture || [],

       techStack: MOCK_JD_RESULT.techStack,
       responsibilities: MOCK_JD_RESULT.responsibilities,
       requirements: MOCK_JD_RESULT.requirements,
       preferred: MOCK_JD_RESULT.preferred || []
    });
